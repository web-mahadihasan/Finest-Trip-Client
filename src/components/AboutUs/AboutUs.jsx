        ...
        <div className="my-24">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-6">
                <div className="order-2 lg:order-1">
                    ...
                    <h3 className="text-2xl md:text-3xl xl:text-5xl font-semibold my-3 font-rubik">We provide the best tour facilities.</h3>
                    <p className="text-lg font-jost text-titleBlack/75 mb-4">
