...
const AddVisa = () => {
    ...
    const handleAddVisa = (e) => {
      ...
      const visaData = {...formData, createdAt, countryImage, countryName, visaType,  processingTime, description, ageRestriction, visaFee, validity, applicationMethod, userEmail, userName}
        ...
        <form onSubmit={handleAddVisa} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input  id="country" type="text" name="countryName" required placeholder="Ex. United States" className="w-full h-10 px-4 font-jost text-base transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-slate-500 autofill:bg-white focus:border-primary-light focus:outline-none bg-white bg-opacity-90" />
            </div>
            ...
            <div>
              ...
              <Select options={options} name="visaType" onChange={optionOnChange} placeholder="Select a visa type"/>
            </div>
             ...
             <div>
              ...
              <input id="processingTime" type="text" name="processingTime" required placeholder="5 - Days" className="w-full h-10 px-4 font-jost text-base transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-slate-500 autofill:bg-white focus:border-primary-light focus:outline-none bg-white bg-opacity-90" />
            </div>
            ...
            <div>
              ...
              <input id="age" type="number" name="ageRestriction" placeholder="45" required className="w-full h-10 px-4 font-jost text-base transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-slate-500 autofill:bg-white focus:border-primary-light focus:outline-none bg-white bg-opacity-90" />
            </div>
            ...
            <div>
              ...
              <input id="visa-fee" type="number" name="visaFee" placeholder="$ 350" required className="w-full h-10 bg-white bg-opacity-90 px-4 font-jost text-base transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-slate-500 autofill:bg-white focus:border-primary-light focus:outline-none" />
            </div>
            ...
            <div>
              ...
              <input id="validity" type="text" name="validity" required placeholder="1 Years" className="w-full h-10 px-4 font-jost text-base transition-all border rounded outline-none focus-visible:outline-none peer border-slate-200 text-slate-500 autofill:bg-white focus:border-primary-light focus:outline-none bg-white bg-opacity-90" />
            </div>
